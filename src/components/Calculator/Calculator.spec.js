...
describe("Calculator", () => {
  ...
  describe("callOperator", () => {
    ...
    it("updates displayValue to '0' if selectedOperator doesn't match cases", () => {
      wrapper.setState({ storedValue: "7" });
    ...
    it("updates displayValue to '0' if called with no value for storedValue ro selectedOperator", () => {
